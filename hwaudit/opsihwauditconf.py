...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
{
   "Class": {
      ...
      "Super":  [ "HARDWARE_DEVICE" ],
      "Opsi":   "PROCESSOR",
      "WMI":    "namespace=root\cimv2:select * from Win32_Processor",
...

{
   "Class": {
      ...
      "Super":  [ "HARDWARE_DEVICE" ],
      "Opsi":   "TPM",
      "WMI":    "namespace=root\cimv2\security\microsofttpm:SELECT * FROM Win32_Tpm"
   },
   "Values": [
      {
         "Type":   "varchar(100)",
